...
from ._base import SESSION_EXPIRED, LONG_EXPIRED, EXPIRED
from .err import RedisClientError
from .utils import ignore_error

__all__ = ("AIORedisClient",)
...
class AIORedisClient(object):
    ...
    def __init__(self, app=None, *, host: str = "127.0.0.1", port: int = 6379, dbname: int = 0, passwd: str = "",
        ...
        """
        self.app = app
        self.pool: aredis.ConnectionPool = None
    ...
    def init_app(self, app, *, host: str = None, port: int = None, dbname: int = None, passwd: str = "",
        ...
        async def open_connection(app_, loop):
            ...
            self.pool = aredis.ConnectionPool(host=host, port=port, db=dbname, password=passwd,
